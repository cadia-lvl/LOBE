...
from wtforms import (BooleanField, FileField, FloatField, Form, HiddenField,
                     IntegerField, MultipleFileField, PasswordField,
                     SelectField, SelectMultipleField, StringField,
                     TextAreaField, TextField, ValidationError, fields,
                     validators, widgets)
...
from models import (Collection, Configuration, Role, User, VerifierIcon,
                    VerifierQuote, VerifierTitle, VerifierLootbox, db)
...
class VerifierLootboxForm(ModelForm):
    class Meta:
        model = VerifierLootbox
