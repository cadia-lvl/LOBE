...
def ds_to_merlinformat(
    src_dir: str, out_dir: str, use_json: bool = True,
...
def copy_to_merlin(src_dir:str, wav_fname:str, txt_fname:str, speaker_name:str):
...
if __name__ == '__main__':
    ds_to_merlinformat('/home/atli/lobe_data/Margrét',
        '/home/atli/lobe_data/ossian_ready/margret1', use_json=True)
